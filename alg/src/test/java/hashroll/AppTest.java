...
public class AppTest{
    ...
    public void smallSequenceTest()
    {
        ...
        answer.add(4);
        answer.add(6);
        ArrayList<Integer> rabinKorpAnswer = rabinKorp.search(pattern, originalString);
        rabinKorp.exportCSV("metrics_small.csv");
        assertTrue(answer.equals(rabinKorpAnswer));
    ...
    public void mediumSequenceTest()
    {
        ...
        answer.add(38);
        ArrayList<Integer> rabinKorpAnswer = rabinKorp.search(pattern, originalString);
        rabinKorp.exportCSV("metrics_medium.csv");
        assertTrue(answer.equals(rabinKorpAnswer));
    ...
    public void largeSequenceTest()
    {
        ...
        ArrayList<Integer> rabinKorpAnswer = rabinKorp.search(pattern, originalString);
        rabinKorp.exportCSV("metrics_large.csv");
        assertTrue(answer.equals(rabinKorpAnswer));
